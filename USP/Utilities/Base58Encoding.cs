...
{
    internal class Base58Encoding
    {
        public const int CheckSumSizeInBytes = 4;

        public static byte[] AddCheckSum(byte[] data)
        {
            System.Diagnostics.Contracts.Contract.Requires<ArgumentNullException>(data != null);
        ...
        {
           // System.Diagnostics.Contracts.Contract.Requires<ArgumentNullException>(data != null);
          //  System.Diagnostics.Contracts.Contract.Ensures(Contract.Result<string>() != null);
